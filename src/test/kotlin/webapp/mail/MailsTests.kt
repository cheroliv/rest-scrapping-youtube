...
class MailSlurpServiceTests {
    ...
    private val token: String by lazy { context.getBean<webapp.ApplicationProperties>().mailbox.test.token }
...
class MailServiceSmtpTests {
    ...
    private val properties: webapp.ApplicationProperties by lazy { context.getBean() }
